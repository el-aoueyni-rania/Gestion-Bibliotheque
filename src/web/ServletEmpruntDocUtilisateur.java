...
/**
 * Servlet implementation class ServletEmpruntDocUtilisateur
 */
@WebServlet("/ServletEmpruntDocUtilisateur")
public class ServletEmpruntDocUtilisateur extends HttpServlet {
    ...
    public ServletEmpruntDocUtilisateur() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		 int cin_e = Integer.parseInt((String)request.getParameter("cin_e")); 
			...
			response.sendRedirect("ServletEmpruntsUtilisateur");
	}
