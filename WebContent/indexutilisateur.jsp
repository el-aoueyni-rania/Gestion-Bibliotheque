						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									...
									<a href="indexutilisateur.jsp" type="button" class="btn btn-default get">Consulter	</a>
								</div>
								<div class="col-sm-6">
					...
					<div class="left-sidebar">
						...
						<div class="panel-group category-Book" id="accordian"><!--category-products-->
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a  href="http://localhost:8081/GestionBib/ServletDocumentsInfoUtilisateur">
											Informatique
										</a>
									</h4>
								</div>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a  href="http://localhost:8081/GestionBib/ServletDocumentsElecUtilisateur">											
											Electrique
										</a>
									</h4>
								</div>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a  href="http://localhost:8081/GestionBib/ServletDocumentsMecUtilisateur">
											Mécanique										
										</a>
									</h4>
								</div>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a  href="http://localhost:8081/GestionBib/ServletDocumentsProcUtilisateur">
											Génie des procédés
										</a>
									</h4>
								</div>							
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a  href="http://localhost:8081/GestionBib/ServletDocumentsComUtilisateur">
											Commerce
										</a>
									</h4>
								</div>								
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a  href="http://localhost:8081/GestionBib/ServletDocumentsAutreUtilisateur">
											Autres
										</a>
									</h4>
								</div>								
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											<img src="images/home/infoo.jpg" alt="" />
											<h2>----</h2>
											<p>Departement Informatique</p>
											<a href="http://localhost:8081/GestionBib/ServletDocumentsInfoUtilisateur" class="btn btn-default add-to-cart">Consulter</a>
										</div>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										...
										<a href="http://localhost:8081/GestionBib/ServletDocumentsElecUtilisateur" class="btn btn-default add-to-cart">Consulter</a>
									</div>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										...
										<a href="http://localhost:8081/GestionBib/ServletDocumentsMecUtilisateur" class="btn btn-default add-to-cart">Consulter</a>
									</div>						
								</div>
							</div>
						</div>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										...
										<a href="http://localhost:8081/GestionBib/ServletDocumentsProcUtilisateur" class="btn btn-default add-to-cart">Consulter</a>
									</div>						
								</div>
							</div>
						</div>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										...
										<a href="http://localhost:8081/GestionBib/ServletDocumentsComUtilisateur" class="btn btn-default add-to-cart">Consulter</a>
									</div>						
								</div>
							</div>
						</div>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										...
										<h2>----</h2>
											<p>Autres</p>
										<a href="http://localhost:8081/GestionBib/ServletDocumentsAutreUtilisateur" class="btn btn-default add-to-cart">Consulter</a>
									</div>						
								</div>
							</div>
						</div>
