                ...
                <div>
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="home">
                            <form action="ServletUpdateUtilisateur"  method="post">
                             <c:if test="${!empty sessionScope.utilisateur  }">
                              <div class="form-group">
                                <label for="cin">CIN</label>
                                <input type="text" class="form-control" name="cin" value="${sessionScope.utilisateur.cin}" readonly >
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="genre" value="  ${sessionScope.utilisateur.genre }">
                              </div>
                              <div class="form-group">
                                <label for="tel">Numéro de téléphone</label>
                                <input type="text" class="form-control" name="tel" value="${sessionScope.utilisateur.tel }">
                              </div>
                              <div class="form-group">
                                <label for="adresse">Adresse</label>
                                <input type="text" class="form-control" name="adresse" value="${sessionScope.utilisateur.adresse } ">
                              </div>
                              <div class="form-group">
                                <label for="date_naiss">Date de naissance</label>
                                <input type="text" class="form-control" name="date" value="${sessionScope.utilisateur.date} ">
                              </div>
                              <div class="form-group">
                                <label for="mail">Mail</label>
                                <input type="mail" class="form-control" name="mail" value=" ${sessionScope.utilisateur.mail } ">
                              </div>
                               <div class="form-group">
                                <label for="password">Password</label>
                                <input type="text" class="form-control" name="pwd" value=" ${sessionScope.utilisateur.pwd } ">
                              </div>
                              <div class="form-group">
                                <label for="role">role</label>
                                <input type="text" class="form-control" name="role" value=" ${sessionScope.utilisateur.role } ">
                              </div>
                                   </c:if>
                              <input type="submit" class="btn btn-default" value="valider" name="action">
