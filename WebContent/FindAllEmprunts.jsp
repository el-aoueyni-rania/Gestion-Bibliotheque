		...
		<div class="header-bottom"><!--header-bottom-->
			<div class="container">
				<div class="row">
					...
					<form action="http://localhost:8081/GestionBib/ServletEmprunts" method="get">
							<input type="text" name="mc"/>
							<input type="submit" value="rechercher" name="action2">
					</form>
...
<c:forEach var="e1" items="${requestScope.emprunts }">
<tr>
<td> ${ e1.id_e} </td>
<td> ${ e1.cin_e} </td>
<td> ${ e1.nom_e} </td>
<td> ${ e1.prenom_e} </td>
<td> ${ e1.titre_doc} </td>
<td> ${ e1.date_emprunt} </td>
<td><a href="http://localhost:8081/GestionBib/ServletEmprunts?action2=Supprimer&id=${ e1.id_e}"> Supprimer</a> </td>
