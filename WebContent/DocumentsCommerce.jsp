...
<title>Documents de departement commerce</title>
...
<header id="header"><!--header-->
		...
		<div class="header-bottom"><!--header-bottom-->
			<div class="container">
				<div class="row">
					...
					<form action="http://localhost:8081/GestionBib/ServletDocumentsCom" method="get">
	...
	<br>
	<h1 class="text-center">Les Documents De Departement Commerce</h1>
	<br><br>
