        ...
        <div class="portlet light profile-sidebar-portlet bordered">
          <div class="logo pull-left">
            ...
            <div class="profile-userpic">
                <img src="images/home/avatar.png" class="img-responsive" alt=""> </div>
            <div class="profile-usertitle">
             <c:if test="${!empty sessionScope.utilisateur  }">
                <div class="profile-usertitle-name">  ${sessionScope.utilisateur.prenom } </div>
                 <div class="profile-usertitle-name">${sessionScope.utilisateur.nom } </div>
                <div class="profile-usertitle-job"> ${sessionScope.utilisateur.role } </div>
                </c:if>
            </div>
...
<form action="FormUpdateUtilisateur.jsp">
<div class="card" style="width: 67rem;">
  <ul class="list-group list-group-flush">
    <li class="list-group-item"> <Strong class="card-title">Cin :  </Strong> ${sessionScope.utilisateur.cin }</li>
    <li class="list-group-item">  <Strong class="card-title">Nom : </Strong> ${sessionScope.utilisateur.nom }</li>
    <li class="list-group-item">  <Strong class="card-title">Prénom : </Strong> ${sessionScope.utilisateur.prenom }</li>
     <li class="list-group-item">  <Strong class="card-title">Genre : </Strong> ${sessionScope.utilisateur.genre }</li>
    <li class="list-group-item">  <Strong class="card-title">Numéro de téléphone : </Strong> ${sessionScope.utilisateur.tel }</li>
    <li class="list-group-item"> <Strong class="card-title">Adresse : </Strong> ${sessionScope.utilisateur.adresse }</li>
     <li class="list-group-item"> <Strong class="card-title">Date de naissance : </Strong>  ${sessionScope.utilisateur.date}</li>
    <li class="list-group-item"> <Strong class="card-title">Mail : </Strong> ${sessionScope.utilisateur.mail }</li>
  </ul>
  <input type="submit" class="btn btn-default" value="modifier" name="action">
</div>
</form>
</div>
</c:if>
