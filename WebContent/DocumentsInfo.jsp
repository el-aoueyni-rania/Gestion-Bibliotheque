...
<title>Documents de departement Informatique</title>
...
<header id="header"><!--header-->
		...
		<div class="header-bottom"><!--header-bottom-->
			<div class="container">
				<div class="row">
					...
					<form action="http://localhost:8081/GestionBib/ServletDocumentsInfo" method="get">
	...
	<br>
	<h1 class="text-center">Les Documents De Departement Informatique</h1>
	<br><br>
