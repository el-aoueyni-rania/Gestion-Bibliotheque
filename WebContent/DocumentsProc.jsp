...
<title>Documents de departement genie des procedes</title>
...
<header id="header"><!--header-->
		...
		<div class="header-bottom"><!--header-bottom-->
			<div class="container">
				<div class="row">
					...
					<form action="http://localhost:8081/GestionBib/ServletDocumentsProc" method="get">
	...
	<br>
	<h1 class="text-center">Les Documents De Departement genie des procedes</h1>
	<br><br>
...
<td> ${d.nbr} </td>
<td> ${d.categorie} </td>
<td><a href="EmpruntDoc.jsp"> Emprunter</a> </td>
</tr>
</c:forEach>
